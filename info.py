...
API_ID = int(environ.get('API_ID', '21838429'))
API_HASH = environ.get('API_HASH', 'b332fd88327ff53231cdf4b3af8c1911')
BOT_TOKEN = environ.get('BOT_TOKEN', "7582800474:AAEJE8yUNNrWXbUbi0O8ePZRr0mk8t_yG-0")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1381669294').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002698355530'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002750135396').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002594014336') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1001372120515')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-4806459757')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002593217164')).split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002640746316').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://hashir532:<nxbdjxbxbxnxnx>@filmhub.utmvxa0.mongodb.net/?retryWrites=true&w=majority&appName=Filmhub")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+COLWnkUC-bgwOGZl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/fillmhubb')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+5UKkHKbWxGAyZWY1) # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/filmmhubbb_bot')
